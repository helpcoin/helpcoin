...
static const int64 MAX_MONEY = 888000000 * COIN; // HelpCoin: maximum of 888M coins (given some randomness), max transaction 888,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 288 / 250; // HelpCoin: 1 blocks found a day. Priority cutoff is 100 helpcoin day / 250 bytes.
    }
