...
void StartRPCThreads()
{
    ...
    ip::tcp::endpoint endpoint(bindAddress, GetArg("-rpcport", /*GetDefaultRPCPort()*/34444));
...
Object CallRPC(const string& strMethod, const Array& params)
{
    ...
    if (!d.connect(GetArg("-rpcconnect", "127.0.0.1"), GetArg("-rpcport", "34444" /*itostr(GetDefaultRPCPort())*/)))
